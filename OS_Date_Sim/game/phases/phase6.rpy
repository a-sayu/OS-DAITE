...
label phase_6:
    ...
    player "Minhas reservas já estão bem baixas, e pra uma viagem longa como essa..."
    ...
    player "Bem, você é um computador de mesa, você não pode ser usado enquanto eu estou andando"
