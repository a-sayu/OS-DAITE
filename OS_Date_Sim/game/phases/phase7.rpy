...
label p7_computer_desk:
    ...
    menu search_desk:
        ...
        "Olhar debaixo da mesa.":
            ...
            "Você nota um caderninho vermelho que parece ter caído dentro de uma caixa de mais documentos."
...
label p7_goto_safe:
    ...
    label p7_wrong_password:

        if wrong_input == 1:
            thoughts "Não funcionou?"
            thoughts "Será que a senha tem algo haver com os caracteres estranhos nas anotações?"
